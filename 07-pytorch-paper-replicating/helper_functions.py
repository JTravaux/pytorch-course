...
def train_model(model: torch.nn.Module,
    ...
    for epoch in tqdm(range(epochs)):
        ...
        writer.add_scalars(main_tag="Loss", tag_scalar_dict={"train_loss": train_res["train_loss"], "test_loss": test_res["test_loss"]}, global_step=epoch)
        writer.add_scalars(main_tag="Accuracy", tag_scalar_dict={"train_acc": train_res["train_acc"], "test_acc": test_res["test_acc"]}, global_step=epoch)
